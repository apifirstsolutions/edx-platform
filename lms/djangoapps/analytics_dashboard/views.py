...
#     get_learners_edu
# )
# from lms.djangoapps.analytics_dashboard.filters import OrderFilter, CourseFilter
...
#
#
# def trainer_view(request, user_id, *args, **kwargs):
...
#     print(f'\nTrainers student: {trainer_course_learner_count}')
#
...
#         trainer_course_year = {}
#     # print(f'\nmont_dist: {trainer_course_year}')
#     # print(f'\nmont_dist: {trainer_course_month}')
#
#     context = {
#         'user_id': user_id,
#         'trainer': trainer,
...
#
#     course_learners = CourseEnrollment.objects.filter(course_id=course_id).values()
...
#     course_learners_user_ids = [l['user_id'] for l in course_learners]
#     print(f'\n ids: {tuple(course_learners_user_ids)}')
#
...
#         'User')
#
#     print(f'\nLearners ({learners_profile.count()}):')
#     for l in learners_profile:
#         print(f'user_profile_id: {l}')
#
#     learners_all = User.objects.filter(id__in=learner_info_users, is_active=1).values()
#     for l in learners_all:
#         print(f'\nLerarners all: {l["id"]}')
#
...
#
#     print(f'\nLearner yob count: {learners_yob.count()}')
#
...
#     }
#
#     return render(request, 'trainer_course_detail.html', context)
#
#
...
#     }
#
#     return render(request, 'admin_demographics.html', context)
#
#

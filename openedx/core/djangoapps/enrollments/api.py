...
def mobile_get_search_enrollments(username, search_param, platform_visibility=None ,include_inactive=False):
    """Retrieves all the courses a user is enrolled in.
    ...
    """
    return _data_api().get_mobile_search_course_enrollments(username, search_param, platform_visibility=platform_visibility, include_inactive=include_inactive)

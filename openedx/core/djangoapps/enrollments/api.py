...
def get_progressdata(username,platform_visibility=None ,include_inactive=False):
    ...
    """
    return _data_api().get_progress_data(username, platform_visibility=platform_visibility, include_inactive=include_inactive)
